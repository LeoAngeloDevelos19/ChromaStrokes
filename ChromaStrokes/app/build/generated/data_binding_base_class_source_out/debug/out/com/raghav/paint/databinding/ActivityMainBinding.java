...
import com.raghav.paint.xml.DrawView;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton btnColor,
      @NonNull ImageButton btnRedo, @NonNull ImageButton btnSave, @NonNull ImageButton btnStroke,
      @NonNull ImageButton btnUndo, @NonNull DrawView drawView, @NonNull LinearLayout linear,
      @NonNull RangeSlider rangebar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, btnColor, btnRedo, btnSave,
          btnStroke, btnUndo, drawView, linear, rangebar);
    }
